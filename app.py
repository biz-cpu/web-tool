...
# ── タイトル直下：系番号一覧 / 使い方 ダイアログ ──
@st.dialog("ℹ️ 系番号一覧", width="large")
def _dlg_zone():
...
A. 「ℹ️ 系番号一覧」ボタンを押して都道府県を確認してください。
...
_btn_col1, _btn_col2, _btn_spacer = st.columns([1, 1, 8])
with _btn_col1:
    if st.button("ℹ️ 系番号一覧", use_container_width=True):
        _dlg_zone()
with _btn_col2:
